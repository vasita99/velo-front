    ...
    async getStatistics() {
      ...
      await axios
        .post("https://vendor-valley.onrender.com/getStatistics", {
          jwtToken:
            "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc1ZlbmRvciI6MSwidXNlcklkIjo3LCJlbWFpbCI6ImpvaG5kb2UuMjNAZ21haWwuY29tIn0.OyERviujO8INs8o0kS7emE_2EpRVEBR4u3QUxElcrXI",
        })
        .then((res) => {
